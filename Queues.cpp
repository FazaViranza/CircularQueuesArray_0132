 ...
 * @date 2025-06-24
 * 
 * @copyright faza@umy.ac.id (c) 2025
 * 
*/
#include <iostream>
using namespace std;
...
{
private:
    static const int max = 5; ///< variable private max untuk menyimpan posisi belakang antrian
...
public:
    ...
    /**
     * @brief method untuk menampilkan data dalamm antrian
